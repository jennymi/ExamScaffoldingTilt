...
static void sendMessage(IOTHUB_CLIENT_LL_HANDLE iotHubClientHandle, char *buffer, bool temperatureAlert, bool pushButtonAlert)
{
    ...
    else
    {
        ...
        Map_Add(properties, "pushButtonAlert", temperatureAlert ? "true" : "false");
